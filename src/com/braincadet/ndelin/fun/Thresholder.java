...
public class Thresholder implements PlugIn {
        ...
        if(myMethod.equals("Try all")){
            ...
            if (stackSize>1 &&( doIstack || doIstackHistogram) ) { //whole stack
                if (doIstackHistogram) {// one global histogram
                    ...
                    IJ.log("function call:");
                    IJ.log("myMethod = " + myMethod);
                    IJ.log("noWhite = " + noWhite);
                    IJ.log("noBlack = " + noBlack);
                    IJ.log("doIwhite = " + doIwhite);
                    IJ.log("doIset = " + doIset);
                    IJ.log("doIlog = " + doIlog);
                    IJ.log("doIstackHistogram = " + doIstackHistogram);
